...
pub fn verify_shplemini(
    ...
    // Layout:
    //   [0]                 = shplonk_Q
    //   [1..=41]            = VK + proof entities (NUMBER_OF_ENTITIES = 41)
    //   [42..=68]           = gemini_fold_comms (CONST_PROOF_SIZE_LOG_N - 1 = 27)
    //   [69]                = generator (1,2) with const_acc scalar
    //   [70]                = kzg_quotient with scalar z
